describe("whatCanIDrink", function() {
    describe("Drinking Age Test", function() {
        it("Should return - Cant Tell the drink as the age is incorrect", function(){
        ...
        it("Should return - Cant Tell the drink as the age is incorrect", function(){
            expect(whatCanIDrink("String_Value")).toBe("Sorry. I can’t tell what drink because that age is incorrect!");
